...
// Search the site and search results
...
function autocompleteSearchSuggestions() {
    ...
    inp.addEventListener("input", function(e) {
        ...
        for (i = 0; i < arr.length; i++) {
            ...
            var hitScore = (arr[i].score * 100).toFixed(1);
            b.innerHTML += "<small style='font-size:9px; border:1px solid grey; background: -webkit-linear-gradient(left, #0cc6f5 " + hitScore + "%, white 0%);'>" + hitScore + "%</small> " + arr[i].title;
